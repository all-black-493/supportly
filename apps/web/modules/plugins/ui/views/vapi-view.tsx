...
const formSchema = z.object({
    publicApiKey: z.string().min(1, { message: "Public API Key is required bruhv" }),
    ...
    return (
        ...
        >
            <DialogContent>
                ...
                <DialogDescription>
                    Are you sure you want to disconnect VAPI plugin? This action cannot be undone.
                </DialogDescription>
                <DialogFooter>
                    <Button
                        variant="destructive"
