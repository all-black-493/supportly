...
import { MonitorIcon, GlobeIcon, ClockIcon } from "lucide-react"
...
export const ContactPanel = () => {
    ...
    const userAgentInfo = useMemo(() => parseUserAgent(contactSession?.metadata?.userAgent),
        ...
        return [
            ...
            },
            {
                ...
                items:[
                    ...
                    {
                        label: "UTC Offset",
                        value: `${-(contactSession.metadata?.timezoneOffset ?? 0) / 60} hours`,
                    },
                ]
            },
            {
